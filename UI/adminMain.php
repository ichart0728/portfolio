      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="adminhighlyRated  Movies.php">Movie Rating</a>
            </li>
            <li class="nav-item">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <div class="intro-heading text-uppercase">HELLO <?php echo $username ?></div>
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Find Movies</a>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      ...
      <?php
        ...
        foreach($rows as $row){
          ...
          $categoryPic = $row['category_pic'];
          echo "<div class='col-md-4 col-sm-6 portfolio-item'>
            <a class='portfolio-link' data-toggle='modal' href='../action/movieAction.php?movietype=$category'>
              <div class='portfolio-hover'>
                <div class='portfolio-hover-content'>
                  <i class='fas fa-plus fa-3x'></i>
                </div>
              </div>
              <img class='img-fluid' src='../img/portfolio/$categoryPic' alt=''>
            </a>
