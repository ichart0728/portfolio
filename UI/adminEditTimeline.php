        ...
        <div class="container-fluid mb-5" style="width:80%;">
            <form action="../action/userAction.php" method="post">
                <div class="row">
                    ...
                    <input style="background-color:#F5A431; color:#161B21;" class="col-md-1 form-control " type="submit" name="adminSearchReview" value="Search">
                </div>
            </form>
            <h1 class="my-5 text-center" style="color:#F5A431;">Timeline</h1>
            <?php
                $userid = $_SESSION['user_id'];
                $rows = $movie->adminDisplayAllreview();
                foreach($rows as $row){
                    ...
                    echo "<div class='card p-0 w-75 mx-auto mb-3'>
                                <div class='card-header'>
                                    <div class='row mx-1'>
                                      ...
                                      <div class='col-md-2 text-right pt-3 px-0 pr-3''>
                                            <a href='../action/movieAction.php?actiontype=deleteReview&id=$reviewid' class= 'border py-2 px-3' style= 'text-decoration:none; border-radius:6px; color:white; background-color:#F5A431;'>Delete</a>   
                                      </div>
                                    </div>
                                </div>
                                <div class='card-body'>
                                    ...
                                    <div class='container'>
                                        <div class='row'>
                                            <div class='col-md-2 pt-2'>
                                                <a href='../UI/adminComment.php?reviewid=$reviewid' style='color:black; text-decoration:none;'>
                                      ...
                                      echo "</div>
                                            <form class='col-md-10' action='../action/movieAction.php' method='post'>
                                                <div class='row'>
                                                    <input class='form-control col-md-10' type='text' name='comment' placeholder='Comment' required='required'>
