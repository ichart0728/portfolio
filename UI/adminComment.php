                  ...
                  "<div class='card-footer border'>
                      <div class='row mx-1 mb-2'>
                        ...
                        <div class='col-md-9 m-0 p-0'>
                            <p class='card-text' style='margin-bottom:0;'> $name's　review</p>
                            <p class='card-text' style='margin-bottom:0;'> $date_commented</p>
                        </div>
                        <div class='col-md-2 text-right pt-3 px-0 pr-3''>
                            <a href='../action/movieAction.php?actiontype=deleteComment&id=$commentid' class= 'border py-2 px-3' style= 'text-decoration:none; border-radius:6px; color:white; background-color:#F5A431;'>Delete</a>   
                        </div>
                      </div>
