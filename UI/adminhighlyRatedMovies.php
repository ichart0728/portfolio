...
<body style="background-color: #161B21;" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    ...
    <section>
        ...
        <h1 class="my-5 text-center" style="color:#F5A431;">Rated Movies</h1>
        <?php
        $rows = $movie->displayMoviesAdmin();
        foreach($rows as $row){
            ...
            "<div class='card w-75 mx-auto mb-4 p-0'>
                <div class='card-body' style='height:465px;'>
                    <div class='row'>
                            <div class='col-md-3'>
                                <a href='../action/movieAction.php?actiontype=adminMovieDetail&id=$movieid'>
                            ...
                            if($checkReview == false){
                              echo "<div class='add col-md-6 pt-2' style='height:100px; cursor:pointer;'>
                              ...
                              echo "<div class='add col-md-6 pt-2' style='height:100px; background-color:#AA7638; cursor:pointer;'>
                ...
                <div class='card-footer'>
                    <div class='container'>
                        ...
                        <p class='mb-0'>Performer: <span>$performer</p>
                    </div>
                </div>
            </div>";                 
        }
